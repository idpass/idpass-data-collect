...
The Admin package provides a Vue.js-based web interface for managing ID PASS Data Collectct deployments, including user management, configuration, and data visualization.
...
# Branding
VITE_APP_TITLE="ID PASS Data Collectct Admin"
