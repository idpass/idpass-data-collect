...
PROGRAM_TARGET_TYPE="individual"
...
log ""
log "Next: on the mobile/admin tenant, the 'Enroll in Program' button on the"
log "widow detail view submits an enrol-in-program event. On next sync the"
