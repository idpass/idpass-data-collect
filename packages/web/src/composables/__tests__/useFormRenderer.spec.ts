...
describe('useFormRenderer', () => {
  ...
  it('constructs a valid FormSubmission with correct fields', async () => {
    ...
    expect(result.submissionGuid).toBe('mock-uuid-1234')
    ...
    expect(submission.guid).toBe('mock-uuid-1234')
    ...
    expect(submission.syncLevel).toBe(1) // SYNCED
  })
  ...
  it('generates a new entityGuid when none is provided', async () => {
    ...
    expect(submission.entityGuid).toBe('mock-uuid-1234')
  })
