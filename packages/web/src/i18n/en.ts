...
export default {
  ...
  citizenLogin: {
    ...
    oidcNotConfigured: "OIDC login is not configured for this program. Contact your administrator.",
  ...
  changeRequest: {
    ...
    submitted: "Your change request has been submitted. Redirecting to submissions...",
  ...
  submissionHistory: {
    ...
    noSubmissions: "No submissions yet. Submit a change request from your dashboard.",
  },
  oidcCallback: {
    ...
    noResponse: "Authentication failed. No response from identity provider.",
    incomplete: "Authentication response is incomplete.",
    noRecord: "No matching beneficiary record found. Please contact your administrator.",
    verifyFailed: "We were unable to verify your identity. Please try again or contact your program administrator.",
  ...
  agentLogin: {
    ...
    noPrograms: "No programs assigned to this account. Contact your administrator.",
  ...
  agentDashboard: {
    ...
    searchResultsCount: "{count} result | {count} results",
    noSearchResults: "No entities found matching your search.",
    register: "Register",
    ...
    noFormMatch: "This record is read-only.",
    saving: "Saving...",
    editEntity: "Edit Entity",
    entityUpdated: "Entity updated successfully. Redirecting...",
    entityNotFound: "Entity not found.",
    noFormSchema: "No form schema available for this entity type.",
    createEntity: "Create Entity",
    entityCreated: "Entity created successfully. Redirecting...",
  },
};
