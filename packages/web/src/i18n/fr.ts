...
export default {
  ...
  citizenLogin: {
    ...
    enterProgramId: "Entrez votre identifiant de programme pour accéder à vos données.",
    programIdLabel: "Identifiant du programme",
    programIdPlaceholder: "ex. registre-menages-demo",
    continue: "Continuer",
    selfServiceDisabled: "Le libre-service n'est pas activé pour ce programme.",
    loginWithEsignet: "Se connecter avec eSignet",
    oidcNotConfigured: "La connexion OIDC n'est pas configurée pour ce programme. Contactez votre administrateur.",
    ...
    chooseAuthMethod: "Choisissez comment vérifier votre identité :",
    loginWithId: "Connexion avec carte d'identité nationale",
    ...
    otpSent: "Un code de vérification a été envoyé. Entrez-le ci-dessous.",
    verificationFailed: "La vérification a échoué. Veuillez vérifier vos informations et réessayer.",
    otpRequestFailed: "Échec de l'envoi du code de vérification. Veuillez réessayer.",
    or: "ou",
  },
  dashboard: {
    welcome: "Bienvenue, {name}",
    manageProfile: "Gérez votre profil et soumettez des demandes de modification.",
  ...
  changeRequest: {
    ...
    submitted: "Votre demande de modification a été soumise. Redirection vers les soumissions...",
  ...
  oidcCallback: {
    ...
    noResponse: "Échec de l'authentification. Aucune réponse du fournisseur d'identité.",
    incomplete: "La réponse d'authentification est incomplète.",
    noRecord: "Aucun enregistrement de bénéficiaire correspondant trouvé. Veuillez contacter votre administrateur.",
    verifyFailed:
  ...
  agentLogin: {
    ...
    noPrograms: "Aucun programme attribué à ce compte. Contactez votre administrateur.",
  ...
  agentDashboard: {
    ...
    searchResultsCount: "{count} résultat | {count} résultats",
    noSearchResults: "Aucune entité trouvée correspondant à votre recherche.",
    register: "Inscription",
    recentEntities: "Entités récentes",
    ...
    noFormMatch: "Cet enregistrement est en lecture seule.",
    saving: "Enregistrement...",
    editEntity: "Modifier l'entité",
    entityUpdated: "Entité mise à jour avec succès. Redirection...",
    entityNotFound: "Entité introuvable.",
    noFormSchema: "Aucun schéma de formulaire disponible pour ce type d'entité.",
    createEntity: "Créer une entité",
    entityCreated: "Entité créée avec succès. Redirection...",
  },
};
