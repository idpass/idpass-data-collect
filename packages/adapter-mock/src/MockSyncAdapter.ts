...
/**
 * Mock sync adapter implementing the legacy ExternalSyncAdapter interface.
 *
 * Pushes events to and pulls entities from a configurable HTTP endpoint.
 * Designed for testing external sync workflows without a real third-party system.
 */
class MockSyncAdapter implements ExternalSyncAdapter {
  private url: string = "";
...
export default MockSyncAdapter;
